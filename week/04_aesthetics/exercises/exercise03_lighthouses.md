...
## **Directory organization** <!-- and the "Como si tal nada" corollary -->

<!-- While cooking with a friend of mine many years ago, he shared one of his mother's sayings: "Como si tal nada." Translated directly, it more or less means "As if there was nothing," but the *implied* meaning, he explained, was "Clean as you go." So we cleaned as we went, scrubbing pots as we used them, and when the meal was finished, it was as if there was nothing in the kitchen at all. -->
...
Just to be safe, open the **Measure** tool one more time to ensure that your buffers were properly generated.

> [![q]][l] 
> 
> 11. Using the `Planar` and `Feet` setting in the **Measure** tool, what is the radius – roughly – of the buffer around the Bardsey lighthouse (its `OBJECTID` = `80`)? You'll probably need to open the attribute table to puzzle this out.

You'll update the symbology in this layer a little later on. -->