...
* Meaningful title, subtitle, explanation of data sources, cartographer information, and date
* Somewhere on the map, the percentage of total land area occupied by parking lots – e.g., (`sq meters of all parking lots` / `sq meters of city`) * `100`
